 ...
 * @author Mateus
 */
public class ClienteDeletarView extends javax.swing.JFrame {

    /**
     * Creates new form ClienteDeletarView
     */
    public ClienteDeletarView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteDeletarView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClienteDeletarView().setVisible(true);
            }
        });
    }
